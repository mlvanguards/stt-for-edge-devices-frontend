...
interface ChatContainerProps {
  messages: Message[];
  onNewMessage: (audioBlob: Blob, transcript: string) => void;
...
const ChatContainer = ({
  ...
  return (
    <div className="w-full flex flex-col bg-white/80 backdrop-blur-sm rounded-3xl overflow-hidden shadow-2xl border border-gray-100">
